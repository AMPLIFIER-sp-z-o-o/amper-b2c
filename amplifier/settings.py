...
MIDDLEWARE = [
    ...
    "apps.support.middleware.tab_aware_session.TabAwareSessionMiddleware",
    "django.middleware.common.CommonMiddleware",
    "django.contrib.redirects.middleware.RedirectFallbackMiddleware",
    "django.middleware.csrf.CsrfViewMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "apps.support.middleware.user_scoped_session.UserScopedSessionMiddleware",
    "apps.support.middleware.cart_context.CartContextMiddleware",
    "apps.support.middleware.admin_access_redirect.AdminAccessRedirectMiddleware",
...
ACCOUNT_SIGNUP_FIELDS = ["email*", "first_name*", "password1*"]
